...
- `media\models\yolo11n_sports_roi_sav19_student_320.onnx`: 11.0 MB ROI-distilled plus SA-V-GT browser-side sports-player segmentation export for local mask overlay generation.
- `media\models\yolo11n_sports_student_320.onnx`: previous ROI-only browser-side sports-player segmentation export retained for comparison.
